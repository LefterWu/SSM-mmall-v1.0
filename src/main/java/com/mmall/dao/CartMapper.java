...
public interface CartMapper {
    ...
    Integer selectUncheckedByUserId(Integer userId);

    void deleteProductByProductIds(@Param("userId") Integer userId, @Param("productIdList") List<Integer> productIdList);
